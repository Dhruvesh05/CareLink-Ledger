  ...
  return (
    <div className="flex h-screen w-full flex-col bg-blue-900 text-white md:w-72">
      <div className="border-b border-blue-700 p-6">
        ...
        <p className="mt-1 text-sm text-blue-200">Patient Portal</p>
      </div>

      <div className="flex-1 overflow-y-auto p-4">
        {menu.map((item) => (
          <button key={item.title} onClick={() => navigate(item.path)} className="w-full flex items-center gap-4 text-left px-4 py-3 rounded-xl hover:bg-blue-700 transition mb-2">
